...
locals {
  ...
  certificate_names      = [for app in var.container_apps : app.ingress.custom_domain != null && length(app.ingress.custom_domain) > 0 ? [for domain in app.ingress.custom_domain : domain.certificate_name != null ? domain.certificate_name : ""] : []]
