...
resource "aws_imagebuilder_infrastructure_configuration" "ec2_ib_container_infrastructure" {
  name                  = "${local.module_prefix}-container-infra"
...
output "ec2_ib_infrastructure_configuration_arn" {
  value = aws_imagebuilder_infrastructure_configuration.ec2_ib_container_infrastructure.arn
}
