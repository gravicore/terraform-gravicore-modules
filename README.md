...
| [MAP Server IDs](aws/map-server-ids)                     | A module for deploying "map35" AWS CloudFormation template to upload a list of on-premise server inventory to AWS Migration Hub for the [AWS Migration Acceleration Program (MAP)](https://aws.amazon.com/migration-acceleration-program/).                                                                                                |
