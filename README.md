...
| [CI/CD](aws/cloudtrail)                              | A module for deploying an IAM user with access keys to be used as a service account for CICD pipelines.                                                                                                                                                                                                 
| [CloudTrail](aws/cicd)                               | A module for deploying all global [CloudTrail](https://aws.amazon.com/cloudtrail/) Events to regional buckets.                                                                                                                                                                                                                                                     |
